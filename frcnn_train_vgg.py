...
def get_data(input_path):
	...
	with open(input_path,'r') as f:
		...
		for line in f:
			...
			filename = "/home/saad/DOTA_devkit/dota-dataset-split/images/" +  filename
...
base_path = '/home/saad/DOTA_devkit/AI/Faster_RCNN/'

train_path =  '/home/saad/DOTA_devkit/train_annotation.txt' # Training data (annotation file)
...
#                 print('Average number of overlapping bounding boxes from RPN = {} for {} previous iterations'.format(mean_overlapping_bboxes, epoch_length))
            ...
            # Convert rpn layer to roi bboxes
            R = rpn_to_roi(P_rpn[0], P_rpn[1], C, keras.backend.image_data_format(), use_regr=True, overlap_thresh=0.7, max_boxes=300)
